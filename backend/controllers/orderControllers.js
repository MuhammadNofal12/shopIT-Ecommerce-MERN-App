...
//Create new Order => /api/v1/orders/new     pay eith cash on delivery, if user chose card, then stripe
...
export const updateOrder = catchAsyncErrors(async (req, res, next) => {
  ...
  if (order?.orderStatus === "Delivered") {
    return next(new ErrorHandler("U have already delivered this order", 404));
  }
...
//Delete order  by id  =>/api/v1/admin/orders/:id
