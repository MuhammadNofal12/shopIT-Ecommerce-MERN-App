...
export const uploadProductImages = catchAsyncErrors(async (req, res) => {
  ...
  //const uploader = async (image) => upload_file(image, "home/product");
...
//     if (!img.public_id) {
//       console.warn("Image missing public_id, skipping:", img);
//       continue;
//     }
//     try {
//       const deleted = await delete_file(img.public_id);
//       console.log(`Deleted Cloudinary image: ${img.public_id}`, deleted);
//       if (!deleted) failedImages.push(img.public_id);
//     } catch (err) {
...
//     failedImages: failedImages.length ? failedImages : null,
//   });
// });
